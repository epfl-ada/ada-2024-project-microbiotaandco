...
df_metadata_OI_compact = pd.merge(df_character_metadata_D, df_movie_metadata[['Freebase Movie ID', 'Movie Box Office Revenue']],
                          on='Freebase Movie ID', how='inner')

df_metadata_OI_compact.to_csv('src/data/characters_preprecessed_for_archetype_revenue.csv', index=False)